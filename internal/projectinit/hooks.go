...
- When creating or updating .md files, READ existing project .md files first and match their style (badges, headers, icons, structure). Generate professional documentation with shields.io badges and clear visual hierarchy.
...
Record key technical choices and their rationale here.

## 🔍 Patterns Discovered

Document coding patterns, conventions, and reusable approaches found in this project.

## 🐛 Known Issues

Track recurring problems, workarounds, and unresolved bugs.

## ⚡ Performance Notes

Record optimization findings, bottlenecks, and benchmark results.
`, name, projectType)
}
